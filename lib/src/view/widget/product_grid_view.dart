...
class ProductGridView extends StatelessWidget {
  ...
  // Hàm tạo phần đầu của mỗi sản phẩm trong grid
  ...
  // Hàm tạo phần thân của sản phẩm (bao gồm hình ảnh)
  ...
  // Hàm tạo phần chân của sản phẩm (bao gồm tên và giá)
